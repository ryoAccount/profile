...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("h2", null, "Please be sure to browse on PC."),
      React.createElement("h2", null, "Not compatible with smartphones."),
      React.createElement("p", null, "Feel free to browse, relax and, please click the button down there?"),

      React.createElement("button", {
        className: "debug-button",
        style: { color: "#303030" },
        onClick: this.handleToggleDebug }, "Debug Mode")),
